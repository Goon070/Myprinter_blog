...
* 위 1,2번 방들을 참고하여 해봤지만 랜선을 연결했는데 연결이 안되는 경우  '홈백홈백' 누르고 Enable Disable menu 누르면 나오는 항목에서 '이더넷' 비활성화되어있다면 켜주세요. \( 홈버튼 1회 -&gt; 백버튼 1회 -&gt; 홈버튼 1회 -&gt; 백버튼 1회 -&gt; Enable Disable menu -&gt; 이더넷 항목 켜주기 \)
